...
import { singleData } from "@/utils/helper";
import { useEffect, useState } from "react";
const Job =  ({ id }: { id: string }) => {

      const router = useRouter();

  const [job, setResult] = useState<Record<string, any>>({});
      ...
      <div className="flex justify-between">
        <div className="ml-5 mt-6">
          ...
          <ul className="list-disc list-inside">
                ...
                <li >
                  <strong>{job.idealCandidate}</strong>
                </li>
        ...
        <div className="ml-20 mr-30">
          ...
          <div className="flex gap-3 mb-4">
            ...
            <div>
              <p>Posted On</p>
              <p className="font-bold">{job.datePosted}</p>
            </div>
          </div>
          <div className="flex gap-3 mb-4">
            <svg
            ...
            <div>
              <p>Deadline</p>
              <p className="font-bold">{job.deadline}</p>
            </div>
          </div>
          <div className="flex gap-3 mb-4">
            <svg
          ...
          <div className="flex gap-3 mb-4">
            ...
            <div>
              <p>Start Date</p>
              <p className="font-bold">{job.startDate}</p>
            </div>
          </div>
          <div className="flex gap-3 mb-4">
            <svg
